                                ...
                                <div className="flex-1/2 flex flex-col gap-10 justify-between md:h-[500px] ">
                                    ...
                                    <div className='flex flex-col justify-center items-center md:flex-row  md:justify-between'>
                                        ...
                                        <div className="flex  flex-col  justify-between items-center md:items-start gap-2 md:gap-2">
                                            ...
                                            <span className="leading-none  mt-2 md:mt-0">4 Bids <span className='text-red-700 cursor-pointer'>Show History</span></span>
                                        </div>
                                    </div>
                                    ...
                                    <button className="btnTheme self-center mt-2 w-full"> PLACE A BID</button>
                                </div>
